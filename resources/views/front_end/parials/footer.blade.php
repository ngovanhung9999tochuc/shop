                ...
                <div class="col-md-4 col-sm-6">
                    <div class="footer-newsletter">
                        ...
                        <div class="newsletter-form">
                            <div >
                                <p><strong>Công Ty Cổ Thế Giới Điện Tử</strong></p>
                                <p><strong>Trụ sở: </strong>Tòa nhà Siêu Việt, 23 Trần Cao Vân, Phường Đa Kao, Quận 1, TP. Hồ Chí Minh.</p>
                                <p><strong>Điện thoại: </strong><span>(028) 7108 2424</span><span class="mx-1">|</span><span>(024) 7308 2424</span></p>
                                <p class="d-none d-md-block"><strong>Email hỗ trợ : </strong>thegioidientu@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
